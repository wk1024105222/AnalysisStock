package wk.stock.price.service.impl;
...
public class PriceServiceImpl implements PriceService {
	 ...
	 * @param task
	 * @return
	 * @see wk.stock.price.service.PriceService#getYahooUrl(wk.stock.price.task.DownDataTask)
	 */
	 ...
	 * @param t
	 * @return
	 * @see wk.stock.price.service.PriceService#downFromYahoo(wk.stock.price.task.DownDataTask)
	 */
	 ...
	 * @param lines
	 * @return
	 * @see wk.stock.price.service.PriceService#savePriceFromYahoo(java.lang.String, java.util.ArrayList)
	 */
	 ...
	 * @param task
	 * @return
	 * @see wk.stock.price.service.PriceService#getSinaTdyUrl(wk.stock.price.task.DownDataTask)
	 */
	 ...
	 * @param line
	 * @return
	 * @see wk.stock.price.service.PriceService#savePriceFromSinaTdy(java.lang.String, java.lang.String)
	 */
	 ...
	 * @param task
	 * @return
	 * @see wk.stock.price.service.PriceService#getSinaSeasonUrl(wk.stock.price.task.DownDataTask)
	 */
	 ...
	 * @param t
	 * @return
	 * @see wk.stock.price.service.PriceService#downFromSinaSeason(wk.stock.price.task.DownDataTask)
	 */
...
//					PriceDownLog pdl = new PriceDownLog(t.getCode(), null, null, year, season, null,"0");
	 ...
	 * @param pdl
	 * @return
	 * @see wk.stock.price.service.PriceService#savePriceFromSinaSeason(java.lang.String, java.lang.String, wk.stock.vo.PriceDownLog)
	 */
