package wk.stock.ppcc.service.impl;
...
import wk.stock.ppcc.dao.PpccDao;
...
public class PpccServiceImpl implements PpccService {
	 ...
	 * @param endDate
	 * @return
	 * @see wk.stock.ppcc.service.PpccService#isNewComputePpccTask(java.util.Date, java.util.Date)
	 */
	 ...
	 * @param endDate
	 * @return
	 * @see wk.stock.ppcc.service.PpccService#getNotFinishPpcc(java.util.Date, java.util.Date)
	 */
	 ...
	 * @param p
	 * @return
	 * @see wk.stock.ppcc.service.PpccService#computePpcc(wk.stock.vo.Ppcc)
	 */
