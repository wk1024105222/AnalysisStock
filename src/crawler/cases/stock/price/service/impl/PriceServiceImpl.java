package crawler.cases.stock.price.service.impl;
...
import crawler.cases.stock.price.task.DownDataTask;
import crawler.cases.stock.vo.PriceDownLog;
...
public class PriceServiceImpl implements PriceService {
	 ...
	 * @param task
	 * @return
	 * @see crawler.cases.stock.price.service.PriceService#getYahooUrl(crawler.cases.stock.price.task.DownDataTask)
	 */
	 ...
	 * @param t
	 * @return
	 * @see crawler.cases.stock.price.service.PriceService#downFromYahoo(crawler.cases.stock.price.task.DownDataTask)
	 */
	 ...
	 * @param lines
	 * @return
	 * @see crawler.cases.stock.price.service.PriceService#savePriceFromYahoo(java.lang.String, java.util.ArrayList)
	 */
	 ...
	 * @param task
	 * @return
	 * @see crawler.cases.stock.price.service.PriceService#getSinaTdyUrl(crawler.cases.stock.price.task.DownDataTask)
	 */
	 ...
	 * @param t
	 * @return
	 * @see crawler.cases.stock.price.service.PriceService#downFromSinaTdy(crawler.cases.stock.price.task.DownDataTask)
	 */
	 ...
	 * @param line
	 * @return
	 * @see crawler.cases.stock.price.service.PriceService#savePriceFromSinaTdy(java.lang.String, java.lang.String)
	 */
	 ...
	 * @param task
	 * @return
	 * @see crawler.cases.stock.price.service.PriceService#getSinaSeasonUrl(crawler.cases.stock.price.task.DownDataTask)
	 */
	 ...
	 * @param t
	 * @return
	 * @see crawler.cases.stock.price.service.PriceService#downFromSinaSeason(crawler.cases.stock.price.task.DownDataTask)
	 */
...
//					PriceDownLog pdl = new PriceDownLog(t.getCode(), null, null, year, season, null,"0");
	 ...
	 * @param pdl
	 * @return
	 * @see crawler.cases.stock.price.service.PriceService#savePriceFromSinaSeason(java.lang.String, java.lang.String, crawler.cases.stock.vo.PriceDownLog)
	 */
