package crawler.stock.price.service.impl;
...
public class PriceServiceImpl implements PriceService {
	 ...
	 * @param task
	 * @return
	 * @see crawler.stock.price.service.PriceService#getYahooUrl(crawler.stock.price.task.DownDataTask)
	 */
	 ...
	 * @param t
	 * @return
	 * @see crawler.stock.price.service.PriceService#downFromYahoo(crawler.stock.price.task.DownDataTask)
	 */
	 ...
	 * @param lines
	 * @return
	 * @see crawler.stock.price.service.PriceService#savePriceFromYahoo(java.lang.String, java.util.ArrayList)
	 */
	 ...
	 * @param task
	 * @return
	 * @see crawler.stock.price.service.PriceService#getSinaTdyUrl(crawler.stock.price.task.DownDataTask)
	 */
	 ...
	 * @param t
	 * @return
	 * @see crawler.stock.price.service.PriceService#downFromSinaTdy(crawler.stock.price.task.DownDataTask)
	 */
	 ...
	 * @param line
	 * @return
	 * @see crawler.stock.price.service.PriceService#savePriceFromSinaTdy(java.lang.String, java.lang.String)
	 */
	 ...
	 * @param task
	 * @return
	 * @see crawler.stock.price.service.PriceService#getSinaSeasonUrl(crawler.stock.price.task.DownDataTask)
	 */
	 ...
	 * @param t
	 * @return
	 * @see crawler.stock.price.service.PriceService#downFromSinaSeason(crawler.stock.price.task.DownDataTask)
	 */
...
//					PriceDownLog pdl = new PriceDownLog(t.getCode(), null, null, year, season, null,"0");
	 ...
	 * @param pdl
	 * @return
	 * @see crawler.stock.price.service.PriceService#savePriceFromSinaSeason(java.lang.String, java.lang.String, crawler.stock.vo.PriceDownLog)
	 */
