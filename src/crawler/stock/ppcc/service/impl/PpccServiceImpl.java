package crawler.stock.ppcc.service.impl;
...
import crawler.stock.ppcc.dao.PpccDao;
...
public class PpccServiceImpl implements PpccService {
	 ...
	 * @param endDate
	 * @return
	 * @see crawler.stock.ppcc.service.PpccService#isNewComputePpccTask(java.util.Date, java.util.Date)
	 */
	 ...
	 * @param endDate
	 * @return
	 * @see crawler.stock.ppcc.service.PpccService#getNotFinishPpcc(java.util.Date, java.util.Date)
	 */
	 ...
	 * @param p
	 * @return
	 * @see crawler.stock.ppcc.service.PpccService#computePpcc(crawler.stock.vo.Ppcc)
	 */
